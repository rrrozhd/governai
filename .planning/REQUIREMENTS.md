...
- [x] **MEM-01**: MemoryConnector protocol defines read/write/search with scope binding (thread, workflow, global)
- [x] **MEM-02**: Memory writes emit audit events (MEMORY_WRITE, MEMORY_READ event types)
- [x] **MEM-03**: In-memory MemoryConnector implementation ships as default; backends are pluggable
